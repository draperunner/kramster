...
const expectJsonStatus200 = function(url, done) {
  server
    .get(url)
...
const expect404 = function(url, done) {
  server
    .get(url)
    .expect(404)
    .end(function(err, res) {
...
describe('List API', function() {
  ...
  it('courses/Norges Teknisk-Naturvitenskaplige Universitet (NTNU)', function(done) {
    expectJsonStatus200(
      '/list/courses/Norges Teknisk-Naturvitenskaplige Universitet (NTNU)',
      done,
    )
  })
  ...
  it('courses/uq', function(done) {
    expectJsonStatus200('/list/courses/uq', done)
  })
  ...
  it('courses/University of Queensland (UQ)', function(done) {
    expectJsonStatus200('/list/courses/University of Queensland (UQ)', done)
  })
